		...
		if(_admob){
			...
			if(ionic.Platform.isAndroid()) {
				_admobid = { // for Android
				    banner: 'ca-app-pub-8818301262480718/4315607013',
				    interstitial: 'ca-app-pub-8818301262480718/5792340214'
				};
			}

		   	if(ionic.Platform.isIOS()){
		    	_admobid = { // for iOS
		    	    banner: 'ca-app-pub-8818301262480718/6778049014',
		    	    interstitial: 'ca-app-pub-8818301262480718/8254782219'
		    	};
		   	}

		   	_opt = {
		   	    bannerId: _admobid.banner,
		   	    interstitialId: _admobid.interstitial,
		   	    adSize: 'SMART_BANNER',
